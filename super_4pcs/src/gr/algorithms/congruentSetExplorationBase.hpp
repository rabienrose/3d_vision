...
CongruentSetExplorationBase<Traits, TransformVisitor, PairFilteringFunctor, OptExts ...>::ComputeTransformation(
  ...
  std::cout<<"number_of_trials_:"<<number_of_trials_<<std::endl;
//   std::cout<<"kDiameterFraction:"<<kDiameterFraction<<std::endl;
//   std::cout<<"MatchBaseType::P_diameter_:"<<MatchBaseType::P_diameter_<<std::endl;
//   std::cout<<"MatchBaseType::max_base_diameter_:"<<MatchBaseType::max_base_diameter_<<std::endl;
//   std::cout<<"first_estimation:"<<first_estimation<<std::endl;
...
//            std::cout << "]\n";
    ...
    if(last_lcp!=best_LCP_){
        last_lcp=best_LCP_;
        std::cout<<"best_LCP_: "<<best_LCP_<<std::endl;
    }
