...
${VOC_ADDR} ${OUT_ADDR}/FREAKTest.bin "freak" 3500 10 6 ${OUT_ADDR}/1/images ${OUT_ADDR}/2/images ${OUT_ADDR}/3/images ${OUT_ADDR}/4/images ${OUT_ADDR}/5/images ${OUT_ADDR}/6/images ${OUT_ADDR}/7/images ${OUT_ADDR}/8/images ${OUT_ADDR}/9/images ${OUT_ADDR}/10/images ${OUT_ADDR}/11/images ${OUT_ADDR}/12/images ${OUT_ADDR}/13/images
