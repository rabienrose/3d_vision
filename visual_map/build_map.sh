BAG_NAME=/media/chamo/095d3ecf-bef8-469d-86a3-fe170aec49db/acuu_test/20190724111212_jt_02.bag
...
#${OPTI_ADDR} --map_addr=${OUT_ADDR} --map_name=1000_chamo.map --opti_type=BA --opti_count=100 --gps_weight=10000000 --t_c_g_x=0.1 --t_c_g_y=0.0 --t_c_g_z=0.0
